...
import { Calendar, Clock, Heart, MapPin, Share2, Star, User} from "lucide-react";
      ...
      cover={
        <div className="relative h-48">
          ...
          <div className="absolute bottom-3 right-3 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <Button size="small" variant="outlined" className="h-8 w-8 p-0 bg-red-500 text-white">
        ...
        title={
          <div className="flex justify-between items-start mb-2">
              ...
              <div className="flex items-center justify-between w-full">
                <h3 className="font-semibold text-lg text-gray-900 mb-1 line-clamp-1">{location.name}</h3>
        ...
        description={
          <div className="space-y-3">
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center space-x-2">
                    <img src={location.owner.image || "https://thanhtra.com.vn/images/avatar-default.png?id=420048c5169f5847774bafb5e8b641b4"} alt={location.owner.fullName} className="h-6 w-6 rounded-full" />
