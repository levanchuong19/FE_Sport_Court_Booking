        ...
        {tab === "overview" && (
          ...
          >
            <div className="mb-4 text-base text-gray-700">
              <b>SportZone</b> là nền tảng quản lý và đặt sân thể thao hiện đại,
              giúp chủ sân:
              <ul className="list-disc ml-6 mt-2">
                <li>
                  Quản lý địa điểm, sân bóng, lịch đặt sân và nhân viên dễ dàng
                </li>
                <li>
                  Kiểm soát doanh thu, trạng thái đặt sân, lịch sử giao dịch
                </li>
                <li>
                  Nhận thông báo đặt sân, nhắc nhở và hỗ trợ khách hàng nhanh
                  chóng
                </li>
                <li>
                  Bảo mật thông tin, giao diện thân thiện, hỗ trợ đa thiết bị
                </li>
                <li>
                  Thống kê số lượt đặt sân, doanh thu từng tháng, hiệu suất hoạt
                  động
                </li>
                <li>Quản lý nhân viên, phân quyền, theo dõi lịch làm việc</li>
                <li>
                  Hỗ trợ nhiều hình thức thanh toán: tiền mặt, chuyển khoản, ví
                  điện tử
                </li>
                <li>
                  Hỗ trợ chủ sân quảng bá địa điểm, thu hút khách hàng mới
                </li>
              </ul>
              <div className="mt-4">
                <b>Hỗ trợ chủ sân:</b>
                <ul className="list-disc ml-6 mt-2">
                  <li>
                    Liên hệ qua email:{" "}
                    <a
                      href="mailto:support@sportzone.com"
                  ...
                  <li>
                    Hotline: <b className="text-blue-700">1900 1234</b>
                  </li>
                  <li>
                    Hướng dẫn sử dụng:{" "}
                    <a
                  ...
                  <li>
                    Fanpage:{" "}
                    <a
                      href="https://facebook.com/sportzone"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-600 underline"
                    >
                      facebook.com/sportzone
                    </a>
                  </li>
                </ul>
              </div>
              <div className="mt-4">
                ...
                <ul className="list-disc ml-6 mt-2">
                  <li>
                    Tạo sân mới, thêm địa điểm, quản lý nhân viên chỉ với vài
                    thao tác
                  </li>
                  <li>
                    Nhận thông báo khi có khách đặt sân hoặc yêu cầu hỗ trợ
                  </li>
            ...
            <div className="flex gap-4 mt-6 justify-center">
              ...
              <Tooltip title="Đến Fanpage">
                <Button
                  ...
                  onClick={() =>
                    window.open("https://facebook.com/sportzone", "_blank")
                  }
                  size="large"
                >
                  Fanpage
        ...
        {tab === "court" && (
          <OwnerCourtTab
            onDetail={(record: Court) => {
              console.log("Court detail:", record);
        ...
        {tab === "booking" && (
          <OwnerBookingTab
            onDetail={(record: Slot) => {
              console.log("Booking detail:", record);
