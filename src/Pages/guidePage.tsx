...
export default function GuidePage() {
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      customAlert("Success", "Gửi thông tin thành công", "default");
    } catch (error) {
      console.log("Form submitted", error);
      customAlert("Error", "Gửi thông tin thất bại", "destructive");
    }
  };
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="w-full py-16 bg-gradient-to-r from-green-500 to-blue-500 text-white text-center">
        ...
        <div className="text-xl opacity-90">
          Tìm hiểu cách sử dụng nền tảng và liên hệ với chúng tôi khi cần hỗ trợ
        </div>
      </div>
      {/* Hướng dẫn sử dụng */}
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="text-center text-gray-500 mb-10">
          Làm theo các bước đơn giản để đặt sân thể thao yêu thích của bạn
        </div>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
          <div className="bg-white rounded-xl shadow p-6 flex flex-col items-center border border-gray-200">
            ...
            <div className="text-gray-500 text-center">
              Tìm kiếm sân thể thao theo địa điểm, loại sân và thời gian mong
              muốn
            </div>
          </div>
          <div className="bg-white rounded-xl shadow p-6 flex flex-col items-center border border-gray-200">
            ...
            <div className="text-gray-500 text-center">
              Chọn ngày giờ phù hợp và xem tình trạng sân còn trống
            </div>
          </div>
          <div className="bg-white rounded-xl shadow p-6 flex flex-col items-center border border-gray-200">
          ...
          <div className="bg-white rounded-xl shadow p-6 flex flex-col items-center border border-gray-200">
            ...
            <div className="text-gray-500 text-center">
              Nhận xác nhận đặt sân qua email và đến sân đúng giờ
            </div>
          </div>
        </div>
        {/* FAQ & Policy */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          <div className="bg-white rounded-xl shadow p-6 border border-gray-200">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-lg">Câu hỏi thường gặp</span>
            </div>
            <div className="mb-3">
              <div className="font-semibold">Làm thế nào để hủy đặt sân?</div>
              <div className="text-gray-500">
                Hiện tại nền tảng chưa hỗ trợ hủy lịch hoàn tiền nên bạn hãy
                kiểm tra thật kỹ trước khi đặt sân.
              </div>
            </div>
            <div className="mb-3">
              <div className="font-semibold">
                Có thể đặt sân cho nhiều ngày không?
              </div>
              <div className="text-gray-500">
                Có, bạn có thể đặt sân định kỳ hàng ngày, hàng tuần hoặc hàng
            ...
            <div>
              ...
              <div className="text-gray-500">
                Chúng tôi hỗ trợ thanh toán qua ví điện từ VNPAY.
              </div>
            </div>
          </div>
          <div className="bg-white rounded-xl shadow p-6 border border-gray-200">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-lg">Chính sách & Quy định</span>
            </div>
            <div className="mb-2">
            ...
            <div className="mb-2">
              ...
              Không thể hủy sân, chỉ có thể linh động đổi lịch.
            </div>
            <div>
              <span className="inline-block bg-gray-100 px-2 py-1 rounded mr-2 text-xs">
                Thiết bị
              </span>{" "}
              Khách hàng tự chuẩn bị dụng cụ thể thao. Một số sân có cho thuê.
            </div>
          </div>
        </div>
        {/* Liên hệ */}
        ...
        <div className="text-center text-gray-500 mb-10">
          Chúng tôi luôn sẵn sàng hỗ trợ bạn 24/7. Hãy liên hệ qua các kênh dưới
          đây
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white rounded-xl shadow p-6 flex flex-col items-center border border-gray-200">
              ...
              <div className="w-full">
                <div className="border border-gray-200 rounded-lg py-2 text-center font-semibold">
                  1900 1234
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow p-6 border border-gray-200">
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="font-semibold">Địa chỉ</span> 123 Nguyễn Văn
              Linh, Q.7, TP.HCM
            </div>
            <div className="flex items-center gap-3 mb-3">
              <Clock className="text-purple-500" />{" "}
              <span className="font-semibold">Giờ làm việc</span> 24/7 - Hỗ trợ
              trực tuyến
            </div>
            {/* Social */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="BOOKING_ISSUE">Lỗi khi đặt sân</option>
                  <option value="PAYMENT_PROBLEM">Gặp vấn đề thanh toán</option>
                  <option value="CANCEL_RESCHEDULE">Hủy / Đổi lịch sân</option>
                  <option value="COURT_CONDITION">
                    Phản ánh chất lượng sân
                  </option>
                  <option value="APP_TECHNICAL">Lỗi kỹ thuật app/web</option>
                  <option value="REFUND_REQUEST">Yêu cầu hoàn tiền</option>
                  <option value="SUGGESTION_FEEDBACK">Góp ý & phản hồi</option>
                  <option value="CUSTOMER_SERVICE">Liên hệ CSKH</option>
