            ...
            <div className="grid gap-4 md:grid-cols-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-10 mt-1 border rounded-md px-3 text-sm focus:ring-2 focus:ring-emerald-500"
                />
              </div>
              <div>
        ...
        <section className="py-16 container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div
                key={idx}
                className="bg-white border rounded-xl p-8 text-center shadow"
              >
        ...
        <section className="py-16 bg-slate-50">
          <div className="container mx-auto grid md:grid-cols-2 gap-8 items-center px-4 max-w-5xl">
            <div className="space-y-6">
              <h2 className="text-3xl md:text-4xl font-bold">
                Tải ứng dụng SportZone
              </h2>
              <p className="text-lg text-gray-600">
                Đặt sân thể thao mọi lúc, mọi nơi với ứng dụng di động của chúng
                tôi. Dễ dàng tìm kiếm, đặt lịch và quản lý các đặt chỗ của bạn.
              </p>
